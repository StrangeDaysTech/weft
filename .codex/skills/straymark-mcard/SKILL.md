...
5. Save to `.straymark/09-ai-models/MCARD-YYYY-MM-DD-NNN-[model-name-slug].md`
...
1. **No `.straymark/09-ai-models/` directory**: Create it before saving
...
5. **No `.straymark/config.yml`**: Default to English (`en`)
