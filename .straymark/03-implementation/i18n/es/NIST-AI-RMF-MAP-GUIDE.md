...
- [ ] Programar revisiones periódicas usando `straymark compliance` para verificar la vigencia del catálogo de riesgos
...
## Resumen: Mapeo de la Función MAP a StrayMark
...
*Guía de Implementación de la Función MAP del NIST AI RMF --- StrayMark Framework*
