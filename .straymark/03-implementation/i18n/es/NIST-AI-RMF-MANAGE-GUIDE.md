...
| Salud del sistema | `straymark status` | Métricas de salud de la documentación |
...
## Resumen: Mapeo de la Función MANAGE a StrayMark
...
*Guía de Implementación de la Función MANAGE del NIST AI RMF --- StrayMark Framework*
