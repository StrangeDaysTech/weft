...
| Requisito NIST | Documento StrayMark | Sección / Campo |
|------------------|-------------------|-----------------|
...
| Métricas de salud de la documentación | `straymark status` | Cobertura, obsolescencia, tasas de revisión |
| Métricas de cumplimiento | `straymark compliance` | Resultados de validación |
...
| Validación de cumplimiento | `straymark compliance` | Salida de validación |
...
- [ ] Ejecutar `straymark compliance` como parte del CI para detectar brechas en la documentación y evaluaciones de riesgos obsoletas
...
## Resumen: Mapeo de la Función MEASURE a StrayMark

| Categoría | Descripción | Documento StrayMark Principal | Campos / Secciones Clave |
|----------|-------------|---------------------------|----------------------|
...
| MS-3 | Seguimiento de Riesgos | AI-RISK-CATALOG.md | Review Date, Status, `straymark compliance` |
| MS-4 | Integración de Retroalimentación | INC, MANAGEMENT-REVIEW-TEMPLATE.md | Post-Mortem Analysis, Action Items |

---

*Guía de Implementación de la Función MEASURE del NIST AI RMF --- StrayMark Framework*
