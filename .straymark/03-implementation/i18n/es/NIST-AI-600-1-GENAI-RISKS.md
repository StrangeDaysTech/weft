...
>
> NIST AI 600-1 define 12 categorías de riesgo específicas para sistemas de IA generativa. Esta referencia mapea cada categoría a las plantillas de StrayMark, valores de frontmatter y mitigaciones prácticas. Úsela junto con las guías de funciones del NIST AI RMF para asegurar una cobertura integral de riesgos de GenAI.
...
## Resumen: Mapeo de Categorías de Riesgo de GenAI a StrayMark

| Categoría | Identificador | Plantilla StrayMark Principal | Valor de Frontmatter |
|----------|-----------|---------------------------|-------------------|
...
*Referencia de Categorías de Riesgo de IA Generativa NIST AI 600-1 --- StrayMark Framework*
