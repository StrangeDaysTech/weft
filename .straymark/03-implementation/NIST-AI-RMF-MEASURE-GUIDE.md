...
| NIST Requirement | StrayMark Document | Section / Field |
|------------------|-------------------|-----------------|
...
| Documentation health metrics | `straymark status` | Coverage, staleness, review rates |
| Compliance metrics | `straymark compliance` | Validation results |
...
- [ ] Run `straymark status` regularly to track documentation health as a governance metric
...
| Compliance validation | `straymark compliance` | Validation output |
...
- [ ] Run `straymark compliance` as part of CI to detect documentation gaps and stale risk assessments
...
## Summary: MEASURE Function to StrayMark Mapping

| Category | Description | Primary StrayMark Document | Key Fields / Sections |
|----------|-------------|---------------------------|----------------------|
...
| MS-3 | Risk Tracking | AI-RISK-CATALOG.md | Review Date, Status, `straymark compliance` |
| MS-4 | Feedback Integration | INC, MANAGEMENT-REVIEW-TEMPLATE.md | Post-Mortem Analysis, Action Items |

---

*NIST AI RMF MEASURE Function Implementation Guide --- StrayMark Framework*
