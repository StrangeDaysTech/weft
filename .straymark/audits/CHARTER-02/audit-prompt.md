...
diff --git a/.straymark/audits/CHARTER-02/audit-prompt.md b/.straymark/audits/CHARTER-02/audit-prompt.md
new file mode 100644
index 0000000..8e6c189
--- /dev/null
+++ b/.straymark/audits/CHARTER-02/audit-prompt.md
@@ -0,0 +1,6135 @@
+<!--
+StrayMark unified audit prompt — v1.1 (EN canonical).
+
...
+  {{git_range}}         — REV..REV that bounds the audit
+  {{git_diff}}          — output of `git diff <git_range>`
+  (none)       — newline-separated list of originating_ailogs paths
+  (none)    — concatenated bodies of those AILOGs
+  auditor        — "auditor" (v1 unified) or legacy "auditor-primary"
+                          / "auditor-secondary" during the v0→v1 transition
+  .straymark/schemas/audit-output.schema.v0.json       — relative path to audit-output.schema.v0.json
+
+Credit: this template lifts seven universal sections (ABSOLUTE RULE, Your
+role, Scope rules, Step 2 mandatory verification, Step 5 severity calibration,
+What you must NOT do, Output format) from the `audit/SKILL.md` skill mature
...
diff --git a/.straymark/audits/CHARTER-02/report-gpt-5-5.md b/.straymark/audits/CHARTER-02/report-gpt-5-5.md
new file mode 100644
index 0000000..495b398
--- /dev/null
+++ b/.straymark/audits/CHARTER-02/report-gpt-5-5.md
@@ -0,0 +1,222 @@
+---
+audit_role: auditor
+auditor: gpt-5-5
